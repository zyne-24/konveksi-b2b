...
export default function Home() {
  return (
    <main className="min-h-screen bg-cream relative overflow-hidden text-emerald-950">
      <BeamBackground />
      <Navbar />
      
      {/* Hero Section */}
      <section id="hero" className="pt-24 pb-32 border-b border-forest-900/10 relative bg-forest-950">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="flex items-center gap-4">
              <a href="#order" className="bg-forest-950 hover:bg-emerald-900 text-white font-medium px-8 py-4 rounded-xl shadow-lg shadow-emerald-950/20 transition-all inline-block">
